...
BifEntry bif_table[] = {
  ...
  {am_erts_internal, am_copy_literals, 2, erts_internal_copy_literals_2, wrap_erts_internal_copy_literals_2},
  {am_erts_internal, am_purge_module, 1, erts_internal_purge_module_1, wrap_erts_internal_purge_module_1},

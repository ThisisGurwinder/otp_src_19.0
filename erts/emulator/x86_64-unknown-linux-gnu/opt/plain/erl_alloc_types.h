...
#define ERTS_ALC_N_MAX_A_SHORT_LIVED (67)

/* Type numbers used for std_alloc */
#define ERTS_ALC_N_MIN_A_STANDARD (68)
#define ERTS_ALC_N_MAX_A_STANDARD (103)

/* Type numbers used for ll_alloc */
#define ERTS_ALC_N_MIN_A_LONG_LIVED (104)
#define ERTS_ALC_N_MAX_A_LONG_LIVED (144)

/* Type numbers used for eheap_alloc */
#define ERTS_ALC_N_MIN_A_EHEAP (145)
#define ERTS_ALC_N_MAX_A_EHEAP (149)

/* Type numbers used for ets_alloc */
#define ERTS_ALC_N_MIN_A_ETS (150)
#define ERTS_ALC_N_MAX_A_ETS (158)

/* Type numbers used for fix_alloc */
#define ERTS_ALC_N_MIN_A_FIXED_SIZE (159)
#define ERTS_ALC_N_MAX_A_FIXED_SIZE (167)

/* Type numbers used for literal_alloc */
#define ERTS_ALC_N_MIN_A_LITERAL (168)
#define ERTS_ALC_N_MAX_A_LITERAL (168)

/* Type numbers used for exec_alloc */
#define ERTS_ALC_N_MIN_A_EXEC (169)
#define ERTS_ALC_N_MAX_A_EXEC (169)

/* Type numbers used for binary_alloc */
#define ERTS_ALC_N_MIN_A_BINARY (170)
#define ERTS_ALC_N_MAX_A_BINARY (172)

/* Type numbers used for driver_alloc */
#define ERTS_ALC_N_MIN_A_DRIVER (173)
#define ERTS_ALC_N_MAX_A_DRIVER (192)

/* Type numbers used for test_alloc */
#define ERTS_ALC_N_MIN_A_TEST (193)
#define ERTS_ALC_N_MAX_A_TEST (193)

#define ERTS_ALC_N_MAX (193)
...
#define ERTS_ALC_T_ETHR_SL (7651)
#define ERTS_ALC_T_DEBUG (7779)
#define ERTS_ALC_T_AINFO_REQ (7907)
#define ERTS_ALC_T_SCHED_WTIME_REQ (8035)
#define ERTS_ALC_T_GC_INFO_REQ (8163)
#define ERTS_ALC_T_SYS_CHECK_REQ (8291)
#define ERTS_ALC_T_FD_LIST (8419)
#define ERTS_ALC_T_ACTIVE_FD_ARR (8547)
#define ERTS_ALC_T_POLLSET_UPDREQ (8675)
#define ERTS_ALC_T_REG_PROC (8788)
#define ERTS_ALC_T_LINK_LH (8916)
#define ERTS_ALC_T_SUSPEND_MON (9044)
#define ERTS_ALC_T_REG_TABLE (9188)
#define ERTS_ALC_T_FUN_TABLE (9268)
#define ERTS_ALC_T_DIST_TABLE (9444)
#define ERTS_ALC_T_NODE_TABLE (9572)
#define ERTS_ALC_T_MODULE_REFS (9652)
#define ERTS_ALC_T_DCACHE (9828)
#define ERTS_ALC_T_DIST_ENTRY (9956)
#define ERTS_ALC_T_NODE_ENTRY (10084)
#define ERTS_ALC_T_ARG_REG (10196)
#define ERTS_ALC_T_PROC_DICT (10324)
#define ERTS_ALC_T_CALLS_BUF (10452)
#define ERTS_ALC_T_BPD (10596)
#define ERTS_ALC_T_LINEBUF (10724)
#define ERTS_ALC_T_IOQ (10852)
#define ERTS_ALC_T_BITS_BUF (10980)
#define ERTS_ALC_T_DB_NTAB_ENT (11076)
#define ERTS_ALC_T_DDLL_HANDLE (11236)
#define ERTS_ALC_T_NODES_MON (11348)
#define ERTS_ALC_T_RE_HEAP (11492)
#define ERTS_ALC_T_PSD (11604)
#define ERTS_ALC_T_PRTSD (11748)
#define ERTS_ALC_T_DIRTY_START (11860)
#define ERTS_ALC_T_THR_Q (12004)
#define ERTS_ALC_T_ETHR_STD (12132)
#define ERTS_ALC_T_DDLL_PROCESS (12260)
#define ERTS_ALC_T_MONITOR_LH (12372)
#define ERTS_ALC_T_NLINK_LH (12500)
#define ERTS_ALC_T_DB_HEIR_DATA (12612)
#define ERTS_ALC_T_NIF_TRAP_EXPORT (12724)
#define ERTS_ALC_T_PORT_DATA_HEAP (12900)
#define ERTS_ALC_T_FD_ENTRY_BUF (13028)
#define ERTS_ALC_T_PRT_REP_EXIT (13156)
#define ERTS_ALC_T_SYS_BLOCKING (13284)
#define ERTS_ALC_T_ATOM (13333)
#define ERTS_ALC_T_MODULE (13493)
#define ERTS_ALC_T_FUN_ENTRY (13621)
#define ERTS_ALC_T_ATOM_TXT (13717)
#define ERTS_ALC_T_TIMER_SERVICE (13925)
#define ERTS_ALC_T_ATOM_TABLE (13973)
#define ERTS_ALC_T_EXPORT_TABLE (14133)
#define ERTS_ALC_T_MODULE_TABLE (14261)
#define ERTS_ALC_T_TAINT (14389)
#define ERTS_ALC_T_PROC_TABLE (14549)
#define ERTS_ALC_T_PORT_TABLE (14693)
#define ERTS_ALC_T_TIMER_WHEEL (14821)
#define ERTS_ALC_T_ASYNC_DATA (14949)
#define ERTS_ALC_T_DB_TABLES (15045)
#define ERTS_ALC_T_INSTR_INFO (15205)
#define ERTS_ALC_T_SCHDLR_SLP_INFO (15333)
#define ERTS_ALC_T_RUNQS (15461)
#define ERTS_ALC_T_DDLL_ERRCODES (15589)
#define ERTS_ALC_T_PRE_ALLOC_DATA (15717)
#define ERTS_ALC_T_CPUDATA (15845)
#define ERTS_ALC_T_CPU_GRPS_MAP (15973)
#define ERTS_ALC_T_AUX_WORK_TMO (16101)
#define ERTS_ALC_T_MISC_AUX_WORK_Q (16229)
#define ERTS_ALC_T_PROC_INTERVAL (16357)
#define ERTS_ALC_T_TRACER_NIF (16485)
#define ERTS_ALC_T_THR_Q_LL (16613)
#define ERTS_ALC_T_ETHR_LL (16741)
#define ERTS_ALC_T_CODE (16821)
#define ERTS_ALC_T_DB_MS_PSDO_PROC (16965)
#define ERTS_ALC_T_SCHDLR_DATA (17125)
#define ERTS_ALC_T_LL_TEMP_TERM (17253)
#define ERTS_ALC_T_EXPORT (17333)
#define ERTS_ALC_T_DRV_TAB (17509)
#define ERTS_ALC_T_DRV_EV_STATE (17637)
#define ERTS_ALC_T_POLLSET (17765)
#define ERTS_ALC_T_POLL_FDS (17893)
#define ERTS_ALC_T_POLL_RES_EVS (18021)
#define ERTS_ALC_T_FD_STATUS (18149)
#define ERTS_ALC_T_SELECT_FDS (18277)
#define ERTS_ALC_T_FD_TAB (18405)
#define ERTS_ALC_T_CS_PROG_PATH (18533)
#define ERTS_ALC_T_BEAM_REGISTER (18646)
#define ERTS_ALC_T_HEAP (18774)
#define ERTS_ALC_T_OLD_HEAP (18902)
#define ERTS_ALC_T_HEAP_FRAG (19030)
#define ERTS_ALC_T_MSG (19158)
#define ERTS_ALC_T_DB_TABLE (19271)
#define ERTS_ALC_T_DB_SEG (19399)
#define ERTS_ALC_T_DB_SEG_TAB (19527)
#define ERTS_ALC_T_DB_STK (19655)
#define ERTS_ALC_T_DB_TRANS_TAB (19783)
#define ERTS_ALC_T_DB_SEL_LIST (19911)
#define ERTS_ALC_T_DB_DMC_ERROR (20039)
#define ERTS_ALC_T_DB_DMC_ERR_INFO (20167)
#define ERTS_ALC_T_DB_TERM (20295)
#define ERTS_ALC_T_PROC (20440)
#define ERTS_ALC_T_MSG_REF (20568)
#define ERTS_ALC_T_LL_PTIMER (20696)
#define ERTS_ALC_T_HL_PTIMER (20824)
#define ERTS_ALC_T_BIF_TIMER (20952)
#define ERTS_ALC_T_MONITOR_SH (21080)
#define ERTS_ALC_T_NLINK_SH (21208)
#define ERTS_ALC_T_DRV_EV_D_STATE (21352)
#define ERTS_ALC_T_DRV_SEL_D_STATE (21480)
#define ERTS_ALC_T_LITERAL (21561)
#define ERTS_ALC_T_HIPE_EXEC (21690)
#define ERTS_ALC_T_DRV_BINARY (21803)
#define ERTS_ALC_T_BINARY (21931)
#define ERTS_ALC_T_SYS_WRITE_BUF (22123)
#define ERTS_ALC_T_PORT (22252)
#define ERTS_ALC_T_DRV (22380)
#define ERTS_ALC_T_DRIVER (22508)
#define ERTS_ALC_T_DRV_CMD_DATA (22636)
#define ERTS_ALC_T_DRV_CTRL_DATA (22764)
#define ERTS_ALC_T_DRV_CALL_DATA (22892)
#define ERTS_ALC_T_NIF (23020)
#define ERTS_ALC_T_PORT_DATA_LOCK (23148)
#define ERTS_ALC_T_DRV_THR_OPTS (23276)
#define ERTS_ALC_T_DRV_TID (23404)
#define ERTS_ALC_T_DRV_MTX (23532)
#define ERTS_ALC_T_DRV_CND (23660)
#define ERTS_ALC_T_DRV_RWLCK (23788)
#define ERTS_ALC_T_DRV_TSD (23916)
#define ERTS_ALC_T_THR_Q_EL (24044)
#define ERTS_ALC_T_THR_Q_EL_SL (24172)
#define ERTS_ALC_T_MISC_AUX_WORK (24300)
#define ERTS_ALC_T_ZLIB (24428)
#define ERTS_ALC_T_ASYNC (24556)
#define ERTS_ALC_T_MSACC (24684)
#define ERTS_ALC_T_TEST (24813)
